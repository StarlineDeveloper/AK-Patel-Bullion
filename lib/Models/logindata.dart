...
class LoginData {
  ...
  factory LoginData.fromJson(Map<String, dynamic> json) => LoginData(
        ...
        group: List<Group>.from(
            jsonDecode(json['Group']).map((x) => Group.fromJson(x))),
        groupDetail: List<GroupDetail>.from(jsonDecode(json['GroupDetail'])
            .map((x) => GroupDetail.fromJson(x))),
      );
...
class GroupDetail {
  ...
  int? goldBuyPremium;
  int? goldSellPremium;
  int? silverBuyPremium;
  int? silverSellPremium;
